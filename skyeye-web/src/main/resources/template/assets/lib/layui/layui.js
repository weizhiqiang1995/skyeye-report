...
if(isNull(localStorage.getItem("systemLanguage"))){
    jsGetJsonFile(reqBasePath + "json/language.json", function(data) {
        systemLanguage = data;
...
// Fontawesome兼容4版本
document.write('<link href="' + reqBasePath + '/assets/lib/fontawesome-free-5.11.2/css/all.css?v=' + skyeyeVersion + '" rel="stylesheet" />');
document.write('<link href="' + reqBasePath + '/assets/lib/fontawesome-free-5.11.2/css/v4-shims.css?v=' + skyeyeVersion + '" rel="stylesheet" />');
